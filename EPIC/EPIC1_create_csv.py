...
df = pd.read_csv("/home/sf522915/EPIC1FINAL_ADAMLIST_list2.csv")





writer = open("/home/sf522915/EPIC1_FINAL_ADAMSLIST_WITHMSE_list2.csv", "w")
spreadsheet = csv.DictWriter(writer, fieldnames=["msID", "mseID","mse","Accession_Number", "EPIC_Project", "VisitType", "Brain_MRI_Date","scanner",\
...
for _, row in df.iterrows():
    ...
    row = {"msID": msid,  "mse":mse,"Accession_Number": acc, "EPIC_Project": project, "VisitType": visit,\
